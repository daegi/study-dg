	...
	<div class="layoutBody">
		<div id="bbs">
			...
			<div id="bbsCreated">
				...
				<div id="bbsCreated_content">
					<dl>
						<dt>내&nbsp;&nbsp;&nbsp;&nbsp;용</dt>
						<dd>
							  <textarea name="content" cols="72" rows="12" class="boxTA"><%=dto.getContent()%></textarea>
						</dd>
					</dl>
				</div>
			...
			<div id="bbsCreated_footer">
				...
				<input type="button" value=" 수정완료 " class="btn2" onclick="sendIt();"/>
				<input type="reset" value=" 다시입력 " class="btn2" onclick=""/>
				<input type="button" value=" 수정취소 " class="btn2" onclick="javascript:location.href='<%=cp%>/bbs/list.jsp?pageNum=<%=pageNum%>';"/>
			</div>
