...
<script type="text/javascript">
	function zipcode_copy(zipcode, address) {
		...
		opener.document.getElementById("zip1").value = zipcode;
...
<body>
	...
	<form id="form1" method="post">
		동을 입력하세요 <input type="text" name="dong" value="<%=dong%>"> <input
	...
	<table border="1" width="550px">
		...
		<tr>
			<td><%=zipcode%></td>
			<td>
				<!-- href="#" 널링크 - 페이지가 이동되지 않도록 처리 --> <a href="#"
				onclick="zipcode_copy('<%=zipcode%>','<%=address2%>')"><%=address%></a>
			</td>
		</tr>
		<%
			}
