...
%>		
	...
	<select name="dong" id="dong"  onchange="form1.submit();">
...
<%
	...
	try{
		if( rs != null ) rs.close();
		if( rs_gugun != null ) rs_gugun.close();
		if( rs_dong != null ) rs_dong.close();
		if( rs_list != null ) rs_list.close();
		if( pstmt != null ) pstmt.close();
		if( pstmt_gugun != null ) pstmt_gugun.close();
		if( pstmt_dong != null ) pstmt_dong.close();
