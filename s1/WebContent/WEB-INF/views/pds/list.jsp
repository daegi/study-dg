		...
		<table width="600" border="0" cellpadding="0" cellspacing="0" style="margin: 0px auto;">
		   ...
		   <tr height="25">
			   ...
			   <td width="220" align="right">
					  <a href="<%=cp%>/pds/update.do?num${dto.num}">수정</a>
		   ...
		   <tr height="30">
			   <td align="left" colspan="3">${dto.content}</td>
			</tr>
		   <tr height="1" bgcolor="#CCCCCC"><td colspan="3"></td></tr>
							   
		   <tr height="50" valign="top">
			   <td align="left" colspan="3" style="padding-top: 5px;">파일설명입니다.</td>
			</tr>
